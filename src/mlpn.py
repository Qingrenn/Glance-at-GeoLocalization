...
class CSWinTransv2_threeIn(nn.Module):
    ...
    def __init__(self, class_num, droprate, decouple, infonce, block=4):
        ...
        # model_ft = timm.create_model('swinv2_base_window12to16_192to256.ms_in22k_ft_in1k', pretrained=False, checkpoint_path='/home/qingren/qr_wkspace/GeoLocalization/checkpoints/swinv2_base_window12to16_192to256.ms_in22k_ft_in1k/pytorch_model.bin')
